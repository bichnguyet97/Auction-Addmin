                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            ...
                            <p class="text-lead text-white">AC Group là Công ty Cổ phần Tập đoàn Đầu tư và Phát triển Dự án Á Châu</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center justify-content-xl-between">
                    <div class="col-xl-12">
                        <div class="copyright text-center text-xl-left text-muted">
                            <span>Bản quyền © 2017 Công ty Đấu giá Hợp danh Số 1 Á Châu.</span>
                        </div>
                    </div>
                    <div class="col-xl-12">
